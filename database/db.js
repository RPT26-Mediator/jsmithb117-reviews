...
const seedReviewsDB = () => new Promise((resolve, reject) => {
...
const refreshReviewDB = () => new Promise((resolve, reject) => {
...
const getListingReviews = (listingID) => new Promise((resolve, reject) => {
  resolve(Reviews.find({ listingID }));
  reject('Error with getting this listings reviews.');
});

const getListingTotalReviewCount = (listingID) => new Promise((resolve, reject) => {
  resolve(Reviews.find({ listingID }).countDocuments());
  reject('Error with getting total review count.');
});

const getAverageReviewRating = (listingID) => new Promise((resolve, reject) => {
  resolve(
    Reviews.aggregate(
      [
        { $match: { listingID } },
...
const deleteReview = (_id) => new Promise((resolve, reject) => {
  resolve(Reviews.deleteOne({ _id }));
  reject('Error with getting total review count.');
});

const getOneReview = (_id) => new Promise((resolve, reject) => {
